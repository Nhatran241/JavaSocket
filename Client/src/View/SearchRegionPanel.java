...
public class SearchRegionPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(scrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 502, Short.MAX_VALUE)
                .addContainerGap())
        );
 ...
 private void initData(List<RelatedTopicReponse> list) {
    ...
    public void loadData(List<SearchRegionRequest> listSearchRegion){
        JPanel listTableContainer = new JPanel(new GridLayout(0,listSearchRegion.size()));
        for (int i = 0; i < listSearchRegion.size(); i++) {
